...
public partial class Laba1Context : DbContext
{
    ...
    public virtual DbSet<Type_t> Types { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Type_t>(entity =>
        {
            entity.ToTable("type");
        ...
        modelBuilder.Entity<ZakazSkidka>(entity =>
        {
            ...
            entity.HasOne(d => d.IdSkidkaNavigation)
                .WithMany(p => p.ZakazSkidkas)
